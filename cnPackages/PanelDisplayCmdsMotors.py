...
if __name__ == "__main__":
	...
	pdc = PanelDisplayCmdsMotors(w, nbChar = 20, nbLine = 10, font = "Helvetica 8 normal")
	pdc.pack()
	scr = pdc.getScr()
	for i in range(40):
